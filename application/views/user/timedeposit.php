...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <form class="needs-validation" role="form" method="post" action="<?php echo base_url('index.php/timedeposit/maketimedep');?>   ">
            <div class="form-row">
                <div class="col-md-8 mb-3 float-md-left" style="background-color: #f1f1f1;border-radius: 10px;">
                    <br>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php
                            //    echo form_open('timedeposit/viewtimedep');
                          //      echo form_close();
                                $curDate = date("Y-m-d");
                        if(isset($view_table)){
                            if ($view_table==NULL){
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal<?php echo $value->tdeptID; ?>" tabindex="-1" role="dialog" aria-hidden="true" style="width: 100%; margin: auto;">
                    ...
                    <div class="row">
                        <div style="width: 100%;">
                            <div class="modal-body">
                                ...
                                <h2 class="text-uppercase">Time Deposit Date</h2>
                                <p class="item-intro text-muted">Widthrawal Date</p>
                                <img class="img-fluid d-block mx-auto" src="img/portfolio/01-full.jpg" alt="">

                                <div class="form">
                                <?php echo form_open('index.php/timedeposit/addTransaction'); ?>
                                        <label for="id">Amount of Money to Deposit</label>
                                        <input type="number" class="form-control"
                                        id="amtDep1" name="amtDep1" max="500000" placeholder="Insert Amount">
                                    ...
                                    Cancel</button>
                                    <?php echo form_submit(array('id' => 'modalDept', 'value' => 'Submit')); ?>
                                    <?php echo form_close();?>
                                </div>

                                    <?php // end of upper loop
                                    echo '</tr>';}}}} else{echo $view_table;}?>
