...
<?php
  ...
  <?php
    ...
    <div class="container box">
             <h3 align="center"><?php echo "Teller Pay Bill"; ?></h3><br />


    <form role="form" method="post" action="<?php echo base_url('tellerpaybill/pay'); ?>">
      ...
      <div class="form-group">
        <label for="exampleInputAmount">User Accountnumber</label>
        <input class="form-control" name="user_account" type="number" placeholder="Enter Amount">
      </div>
  <!--  <div class="form-group">
