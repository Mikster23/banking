 ...
 <br><br>
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> User Transfer History</div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="%" cellspacing="0">
              <thead>
                ...
                <th style="text-align:center;">Action</th>
                  ...
                  <th style="text-align:center;">Balance Before Transaction </th>
                  <th style="text-align:center;">Balance After Transaction</th>
              ...
              <?php foreach ($usertrans as $person_item): ?>
                    <tr>
                      ...
                      <td style="text-align:center;"><?php echo $person_item['balbefore']; ?></td>
                      <td style="text-align:center;"><?php echo $person_item['balafter']; ?></td>
