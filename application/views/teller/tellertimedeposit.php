...
?>
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <form class="needs-validation" role="form" method="post" action="<?php echo base_url('tellertimedeposit/maketimedep');?>   ">
                <div class="form-row">
                                        ...
                                        <div class="row">
                                            <div style="width: 100%;">
                                                <div class="modal-body">
                                                    ...
                                                    <form class="needs-validation" role="form" method="post" action="<?php echo base_url('tellertimedeposit/extendTD');?>   ">
