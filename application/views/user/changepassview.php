...
<?php
  ...
  <?php
    ...
    <div class="form-group">
      ...
      <input class="form-control" name="user_oldpass" type="number"  placeholder="Enter Pin">
    </div>

    <div class="form-group">
      <label for="exampleInputPin">Enter New Password</label>
      <input class="form-control" name="user_newpass" type="number"  placeholder="Enter Pin">
    </div>

      <input class="btn btn-primary btn-block" type="submit" required value="PAY" name="deposit" >
