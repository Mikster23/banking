        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-25">
              ...
              <select id="type" name="dep_atm" value=" <?php echo $news_item['depatm']?>">
                <?php if((int)$news_item['depatm']==1){
          ...
          <div class="row">
            <div class="col-25">
              ...
              <select id="type" name="with_atm" value="<?php echo $news_item['withatm']?>">
                <?php if((int)$news_item['withatm']==1){
          ...
          <div class="row">
            <div class="col-25">
              ...
              <select id="type" name="dep_tel" value="<?php echo $news_item['deptel']?>">
                <?php if((int)$news_item['deptel']==1){
          ...
          <div class="row">
            <div class="col-25">
              ...
              <select id="type" name="with_tel" value="<?php echo $news_item['withtel']?>">

                <?php if((int)$news_item['withtel']==1){
